        ...
        <div class="content" style="height: auto;">
            ...
            <div style="display: flex; flex: 1; flex-direction: column; width: 100%; padding: 20px 20px 0px 20px;">
                ...
                <md-slider-container flex style="margin-top: 0px;">
                    ...
                    <input type="number" min="0" max="{{maxViewshedOffset}}" style="height: 48px; line-height: 48px; font-size: 14px; text-align: center; border: none;" ng-model="viewshedOffset" ng-change="handleViewshedOffsetChange()"/>
                    </md-slider-container>
