...
export const PROFILE_SERVICE_DEFAULT_URL = 'https://maps.geogratis.gc.ca/elevation/${source}/profile';
...
export const VIEWSHED_SERVICE_DEFAULT_URL = 'https://maps.geogratis.gc.ca/elevation/${source}/profile';
...
export const MAX_VIEWSHED_OFFSET = 100;
